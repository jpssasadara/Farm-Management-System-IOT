<table>
    ...
    if ($result = $mysqli->query($query)) {
        ...
        <tr>
            <td>First Name</td><td><input type=\"text\" name=\"name\" class=\"form-control\" required value='{$row['fn']}'/></td>
        </tr>
        <tr>
            <td>Last Name</td><td><input type=\"text\" name=\"name\" class=\"form - control\" required value='{$row['ln']}'/></td>
        </tr>
        <tr>
