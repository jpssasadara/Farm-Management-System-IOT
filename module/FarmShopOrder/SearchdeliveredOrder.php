...
<?php  
 ...
 if($d1!== null AND   $d2!== null AND  $d3 !== null){
		 ...
		 $query2 = "SELECT t1.OrderNumber,t1.Date,t2.Code,t1.Amount,t1.Reg_Shop_Id,t2.Name FROM regshoporder t1 INNER JOIN items t2 ON t1.Item_Code = t2.Code  WHERE t1.Verified=1 AND t1.Delivered=1  AND t1.Reg_Shop_Id= '$d1'  AND t2.Code= '$d3'   ";  
